...
public class DialogDemo {
    ...
    private static void recognizeDigits(LiveSpeechRecognizerExtension recognizer) {
    ...
    private static void recognizerBankAccount(LiveSpeechRecognizerExtension recognizer) {
    ...
    private static void recognizeWeather(LiveSpeechRecognizerExtension recognizer) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LiveSpeechRecognizerExtension grxmlRecognizer =
            new LiveSpeechRecognizerExtension(configuration);

        configuration.setUseGrammar(false);
        configuration.setLanguageModelPath(LANGUAGE_MODEL);
        LiveSpeechRecognizerExtension lmRecognizer =
            new LiveSpeechRecognizerExtension(configuration);
